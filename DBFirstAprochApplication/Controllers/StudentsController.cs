...
namespace DBFirstAprochApplication.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var schoolSystemContext = _context.Students.Include(s => s.Class);
        ...
        public async Task<IActionResult> Create([Bind("StudentId,Name,Dob,Gender,Mobile,RollNo,Address,ClassId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,Name,Dob,Gender,Mobile,RollNo,Address,ClassId")] Student student)
        {
