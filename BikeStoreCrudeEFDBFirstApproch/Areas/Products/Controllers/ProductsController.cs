...
namespace BikeStoreCrudeEFDBFirstApproch.Areas.Products.Controllers
{
    [Area("Products")]
    public class ProductsController : Controller
    {
        ...
        {
            var bikestoreContext = _context.Products.Include(p => p.Brand).Include(p => p.Category);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BikestoreContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
